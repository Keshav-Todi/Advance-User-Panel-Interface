...
public class computer
{
    ...
    int go=0;
    //gf ob=new gf();
    ImageIcon i=new ImageIcon(getClass().getResource("galu.jpg")); 
    JLabel l8=new JLabel(i);
    ImageIcon i1=new ImageIcon(getClass().getResource("calcu.jpg")); 
    JLabel l9=new JLabel(i1);
    ImageIcon i2=new ImageIcon(getClass().getResource("stopu.jpg")); 
    ...
    public  void gall()
    {
        ...
        //p.add(l);
        //p.add(l3);
        JButton btgalu=new JButton(" Gallery ");
        JButton btcalcu=new JButton(" Calculator ");
        JButton btstopi=new JButton(" Stopwatch ");
        ///////////////////////////////
